...
const  UserRepoPage = props => {
    ...
    return (
        <div className="container  my-3">
           { error ? <Error> An error occured while loading the user repositories </Error> : 
           <>
           ...
           <div className="row justify-content-center mt-5">
                ...
                <div className="row justify-content-center">
                    {
                        repositories.length < 1 ? <div className="alert alert-info text-center">No repository </div> : null
                    }
