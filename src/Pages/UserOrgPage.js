...
const  UserOrgPage = (props) => {
    ...
    return (
        <div className="container my-2">
            { error ? <Error>An Error occured while loading the user data</Error> : 
                <>
                <div className="row justify-content-center my-2">
                    <div className="col-6 text-center">
                            <img src={user.avatar_url} alt="user_profil" width="50%" className="rounded"/>
                    </div>
               </div>
               <hr></hr>
               <div className="row justify-content-center mt-5">
                    ...
                    {
                        organizations.length < 1 ? <div className="alert alert-info text-center">No Organization </div> : null
                    }
                    {
                        organizations.length < 1 ? <Loader/> : 
